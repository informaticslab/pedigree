Family Heath iPhone App (Pedigree)
===========
The Family History app provides similar functionality as the Surgeon General's My Family Health Portait website (https://familyhistory.hhs.gov).

Issue tracker is available: http://code.phiresearchlab.org/jira/browse/PED

## Goals
To develop and share an iOS version of the Surgeon General's My Family Health Portait website.
